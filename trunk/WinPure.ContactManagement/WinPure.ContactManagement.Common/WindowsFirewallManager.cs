//Code from http://www.codeproject.com/KB/winsdk/WinXPSP2Firewall.aspx.
using System;
using System.IO;
using NetFwTypeLib;
...
namespace WinPure.ContactManagement.Common
{
    public class WindowsFirewallManager
    {
        ...
        public enum FW_ERROR_CODE
        {
            ...
            // Failed to get or put the UnicastResponses To MulticastBroadcast Disabled Property 
        ...
        private INetFwProfile m_FirewallProfile;
